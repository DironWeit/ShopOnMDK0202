        ...
        <div class="row gy-sm-5 gy-4 align-items-center">
            ...
            <div class="col-xl-3 col-sm-6 order-xl-0 order-2">
                <div class="position-relative z-index-1">
                    <img src="assets/images/shapes/dots-sm.png" alt="" class="dotted-img d-xl-block d-none">
  ...
  <img src="assets/images/shapes/brush.png" alt="" class="element-brush">
    ...
    <div class="container container-two">
        <div class="section-heading">
            <h3 class="section-heading__title">Popular Items</h3>
        </div>

        <ul class="nav common-tab style-icon justify-content-center align-items-center nav-pills mb-48" id="pills-tab-popular" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="pills-all-two-tab" data-bs-toggle="pill" data-bs-target="#pills-all-two" type="button" role="tab" aria-controls="pills-all-two" aria-selected="true">
                <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="WordPress">
                    <img src="assets/images/thumbs/tech-icon1.png" alt="">
                    <span class="text">WordPress</span>
                </span>
              </button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-laravel-tab" data-bs-toggle="pill" data-bs-target="#pills-laravel" type="button" role="tab" aria-controls="pills-laravel" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="laravel">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-popular-php-tab" data-bs-toggle="pill" data-bs-target="#pills-popular-php" type="button" role="tab" aria-controls="pills-popular-php" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="PHP">
                    <img src="assets/images/thumbs/tech-icon3.png" alt="">
                    <span class="text">PHP</span>
                </span>
              </button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-HTML-tab" data-bs-toggle="pill" data-bs-target="#pills-HTML" type="button" role="tab" aria-controls="pills-HTML" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="HTML">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-Sketch-tab" data-bs-toggle="pill" data-bs-target="#pills-Sketch" type="button" role="tab" aria-controls="pills-Sketch" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Sketch">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-Figma-tab" data-bs-toggle="pill" data-bs-target="#pills-Figma" type="button" role="tab" aria-controls="pills-Figma" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Figma">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-bootstrap-tab" data-bs-toggle="pill" data-bs-target="#pills-bootstrap" type="button" role="tab" aria-controls="pills-bootstrap" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Bootstrap">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-tailwind-tab" data-bs-toggle="pill" data-bs-target="#pills-tailwind" type="button" role="tab" aria-controls="pills-tailwind" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tailwind">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-react-tab" data-bs-toggle="pill" data-bs-target="#pills-react" type="button" role="tab" aria-controls="pills-react" aria-selected="false">
                  <span class="tech-list__item flx-align gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="React">
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item1.png" alt="">
            </a>

            <div class="product-card__bottom flx-between gap-2">
                <div>
                    <span class="product-card__sales font-14 mb-0">100 Sales</span>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> SaaS for Finance Management</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item2.png" alt="">
            </a>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> zirtrust - Fintech SaaS Ui kit</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item3.png" alt="">
            </a>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> yolla - CRM Software Landingpage</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item4.png" alt="">
            </a>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> Business point - HR UX-UI design Template</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item5.png" alt="">
            </a>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> Wonder AI Landing Page Template</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item6.png" alt="">
            </a>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> turing UI Kit: AI Smart Healthcare App </a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item7.png" alt="">
            </a>
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> FinTrust - Fintech SAAS Ui kit</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item9.png" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item10.png" alt="">
            </a>
    ...
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
            <a href="product-details.html" class="link w-100"> 
                <img src="assets/images/thumbs/popular-item11.png" alt="">
            </a>
    ...
    <div class="popular-item-card">
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            <h6 class="popular-item-card__title mb-0">
                <a href="product-details.html" class="link"> amiz - SaaS customer Website Template</a>
            </h6>
            <a href="product-details.html" class="btn-link line-height-1 flex-shrink-0">
                <img src="assets/images/icons/link.svg" alt="">
            </a>
            ...
            <div class="tab-pane fade" id="pills-laravel" role="tabpanel" aria-labelledby="pills-laravel-tab" tabindex="0">
              <div class="row gy-4">
    <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-6">
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
    ...
    <div class="popular-item-card">
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            ...
            <div class="tab-pane fade" id="pills-popular-php" role="tabpanel" aria-labelledby="pills-popular-php-tab" tabindex="0">
              <div class="row gy-4">
    <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-6">
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
    ...
    <div class="popular-item-card">
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            ...
            <div class="tab-pane fade" id="pills-HTML" role="tabpanel" aria-labelledby="pills-HTML-tab" tabindex="0">
              <div class="row gy-4">
    <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-6">
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
    ...
    <div class="popular-item-card">
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            ...
            <div class="tab-pane fade" id="pills-Sketch" role="tabpanel" aria-labelledby="pills-Sketch-tab" tabindex="0">
              <div class="row gy-4">
    <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-6">
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
    ...
    <div class="popular-item-card">
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            ...
            <div class="tab-pane fade" id="pills-Figma" role="tabpanel" aria-labelledby="pills-Figma-tab" tabindex="0">
              <div class="row gy-4">
    <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-6">
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
    ...
    <div class="popular-item-card">
        ...
        <div class="popular-item-card__content d-flex align-items-center justify-content-between gap-2 text-start">
            ...
            <div class="tab-pane fade" id="pills-react" role="tabpanel" aria-labelledby="pills-react-tab" tabindex="0">
              <div class="row gy-4">
    <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-6">
    <div class="popular-item-card">
        <div class="popular-item-card__thumb">
...
<section class="selling-product padding-y-120 position-relative z-index-1 overflow-hidden">
    ...
    <div class="product-card__content">
        ...
        <div class="product-card__bottom flx-between gap-2">
            ...
            <div class="flx-align gap-2">
                <a href="product-details.html" class="btn btn-outline-light btn-icon btn-icon--sm pill"> 
                    <span class="icon"><img src="assets/images/icons/download.svg" alt=""></span>
                </a>
...
<section class="featured-contributor padding-y-120 position-relative z-index-1 overflow-hidden">
    ...
    <img src="assets/images/shapes/pattern-curve-3.png" alt="" class="position-absolute start-0 top-0 z-index--1">

    <img src="assets/images/shapes/element-moon1.png" alt="" class="element two">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="section-content">
                    <div class="section-heading style-left">
                        <h3 class="section-heading__title">Featured Contributors</h3>
                        <p class="section-heading__desc font-18 w-sm">Who creates useful, qualitful, customer centric digital products</p>
                    </div>
                    <a href="profile.html" class="btn btn-main btn-lg pill fw-300"> All Contributors </a>
                </div>
            </div>
    ...
    <div class="contributor-item">
        <img src="assets/images/icons/madel-badge.png" alt="" class="contributor-item__badge">
        <div class="contributor-item__content">
            <div class="contributor-info flx-align gap-2">
                <div class="contributor-info__thumb">
                    <img src="assets/images/thumbs/contributor-img1.png" alt="">
                </div>
                <div class="contributor-info__content">
                    <h6 class="contributor-info__name mb-1 text-white">Amplify</h6>
                    <span class="contributor-info__text text-white font-14">12558 Sold Items</span>
                </div>
            </div>
            <div class="contributor-item__thumb">
                <img src="assets/images/thumbs/contributor1.png" alt="" class="cover-img">
    ...
    <div class="contributor-item">
        ...
        <div class="contributor-item__content">
            <div class="contributor-info flx-align gap-2">
                <div class="contributor-info__thumb">
                    <img src="assets/images/thumbs/contributor-img2.png" alt="">
                </div>
                <div class="contributor-info__content">
                    <h6 class="contributor-info__name mb-1 text-white">Radiuspoint</h6>
                    <span class="contributor-info__text text-white font-14">35462 Sold Items</span>
                </div>
            </div>
            <div class="contributor-item__thumb">
                <img src="assets/images/thumbs/contributor2.png" alt="" class="cover-img">
                <a href="#" class="contributor-item__link">
                    <img src="assets/images/icons/link-white.svg" alt="">
                </a>
            </div>
    ...
    <div class="contributor-item">
        ...
        <div class="contributor-item__content">
            <div class="contributor-info flx-align gap-2">
                <div class="contributor-info__thumb">
                    <img src="assets/images/thumbs/contributor-img3.png" alt="">
                </div>
                <div class="contributor-info__content">
                    <h6 class="contributor-info__name mb-1 text-white">Ovious</h6>
                    <span class="contributor-info__text text-white font-14">2542 Sold Items</span>
                </div>
            </div>
            <div class="contributor-item__thumb">
                <img src="assets/images/thumbs/contributor3.png" alt="" class="cover-img">
                <a href="#" class="contributor-item__link">
                    <img src="assets/images/icons/link-white.svg" alt="">
                </a>
            </div>
    ...
    <div class="contributor-item">
        ...
        <div class="contributor-item__content">
            <div class="contributor-info flx-align gap-2">
                ...
                <div class="contributor-info__content">
                    <h6 class="contributor-info__name mb-1 text-white">Themex</h6>
                    <span class="contributor-info__text text-white font-14">6854 Sold Items</span>
                </div>
            </div>
            <div class="contributor-item__thumb">
                <img src="assets/images/thumbs/contributor1.png" alt="" class="cover-img">
...
<section class="service padding-y-120 position-relative z-index-1 overflow-hidden">
    <img src="assets/images/shapes/curve-pattern3.png" alt="" class="position-absolute end-0 top-0 z-index--1">
    <img src="assets/images/shapes/element1.png" alt="" class="element two">
    <div class="container container-two">
        <div class="section-heading style-left style-flex flx-between align-items-end gap-3">
            <div class="section-heading__inner w-lg">
                <h3 class="section-heading__title">Best services we provide</h3>
            ...
            <a href="#" class="btn btn-main btn-lg pill">See All Services</a>
        </div>
        <div class="row gy-4">
            <div class="col-lg-4 col-sm-6 col-xs-6">
    <div class="service-item hover-bg-main">
        <img src="assets/images/gradients/service-hover-bg.png" alt="" class="hover-bg">
        <span class="service-item__icon">
            <img src="assets/images/icons/service-icon1.svg" alt="">
        </span>
        <h5 class="service-item__title my-3">Website Design & Development</h5>
        <p class="service-item__desc">We help companies communicate with customers more effectively and efficiently. Help is a conversational customer support.</p>
    ...
    <div class="service-item hover-bg-main">
        ...
        <h5 class="service-item__title my-3">Management Systems Development</h5>
        <p class="service-item__desc">We help companies communicate with customers more effectively and efficiently. Help is a conversational customer support.</p>
        <a href="#" class="btn-simple">Read More <span class="icon"><i class="las la-arrow-right"></i></span> </a>
    </div>
</div>
    ...
    <div class="service-item hover-bg-main">
        ...
        <h5 class="service-item__title my-3">Digital Marketing & Video Editing</h5>
        <p class="service-item__desc">We help companies communicate with customers more effectively and efficiently. Help is a conversational customer support.</p>
        <a href="#" class="btn-simple">Read More <span class="icon"><i class="las la-arrow-right"></i></span> </a>
    </div>
</div>
    ...
    <div class="service-item hover-bg-main">
        ...
        <h5 class="service-item__title my-3">Graphic Design & UI/UX</h5>
        <p class="service-item__desc">We help companies communicate with customers more effectively and efficiently. Help is a conversational customer support.</p>
        <a href="#" class="btn-simple">Read More <span class="icon"><i class="las la-arrow-right"></i></span> </a>
    </div>
</div>
    ...
    <div class="service-item hover-bg-main">
        ...
        <h5 class="service-item__title my-3">Blockchain Crypto web3 Development</h5>
        <p class="service-item__desc">We help companies communicate with customers more effectively and efficiently. Help is a conversational customer support.</p>
        <a href="#" class="btn-simple">Read More <span class="icon"><i class="las la-arrow-right"></i></span> </a>
    </div>
</div>
    ...
    <div class="service-item hover-bg-main">
        ...
        <h5 class="service-item__title my-3">Content Creation & SEO</h5>
        <p class="service-item__desc">We help companies communicate with customers more effectively and efficiently. Help is a conversational customer support.</p>
        <a href="#" class="btn-simple">Read More <span class="icon"><i class="las la-arrow-right"></i></span> </a>
    </div>
</div>
...
<section class="testimonial padding-y-120 position-relative section-bg overflow-hidden">
    ...
    <img src="assets/images/gradients/testimonial-bg.png" alt="" class="hover-bg">
...
<!-- ======================== Brand Section End ========================= -->
<!-- ======================= Become seller Two section start ==================== -->
<section class="seller-two position-relative z-index-1 overflow-hidden">

    <img src="assets/images/shapes/spider-net.png" alt="" class="spider-net position-absolute bottom-0 end-0 z-index--1">
        ...
        <div class="row gy-4">
            <div class="col-lg-6">
                <div class="seller-item position-relative z-index-1">
                    ...
                    <h3 class="seller-item__title">Become a Seller</h3>
                    <p class="seller-item__desc fw-500 text-heading">Sellers receive 75% of the Item Price for items sold exclusively and 50% for items sold non-exclusively. See detailed informationabout the fee structure on Market.</p>
                    <a href="register.html" class="btn btn-outline-black btn-xl pill fw-600">Create Seller Account</a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="seller-item bg-three position-relative z-index-1">
                    <img src="assets/images/shapes/seller-bg-three.png" class="position-absolute
                    start-0 top-0 z-index--1" alt="">
                    <h3 class="seller-item__title">Earn untill 40% commission</h3>
                    ...
                    <a href="register.html" class="btn btn-outline-black btn-xl pill fw-600">Get More Commission</a>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="support-two position-relative z-index-1 padding-t-60">
                    
                    <div class="row align-items-center">

                        <div class="col-lg-3 col-sm-7">
                            <div class="support-content ps-0">
                                <h3 class="support-content__title mb-3">Support 24/7</h3>
                                <p class="support-content__desc font-19">Wanna talk? Send us a message</p>
                                <a href="mailto:infomail@office.com" class="btn btn-main btn-lg fw-300 pill">infomail@office.com</a>
                            </div>
                        </div>

                        <div class="col-lg-5 d-lg-block d-none">
                            <div class="arrow-img h-100 d-flex align-items-end">
                                <img src="assets/images/shapes/arrow-shape-two.png" alt="">
                            </div>
                        </div>
                        
                        <div class="col-lg-4 col-sm-5 d-sm-block d-none">
...
<!-- ======================= Become seller Two section End ==================== -->
<!-- =========================== Article Section Start ============================ -->
<section class="article padding-y-120 ">
    <div class="container container-two">
        <div class="section-heading style-left style-flex flx-between align-items-end gap-3">
...
<section class="resource  padding-y-120 section-bg position-relative z-index-1 overflow-hidden">
    ...
    <img src="assets/images/shapes/element-moon3.png" alt="" class="element one">
    <img src="assets/images/shapes/curve-pattern3.png" alt="" class="d-none position-absolute end-0 top-0 z-index--1">
    ...
    <div class="product-card__content">
        ...
        <div class="product-card__info flx-between gap-2">
            ...
            <div class="flx-align gap-2">
                <h6 class="product-card__price mb-0">$100</h6>
                <span class="product-card__prevPrice text-decoration-line-through">$130</span>
            </div>
        </div>
        <div class="product-card__bottom flx-between gap-2">
            <div>
                <span class="product-card__sales font-14 mb-2">952 Sales</span>
                <div class="d-flex align-items-center gap-1">
                    <ul class="star-rating">
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
    ...
    <div class="product-card__content">
        ...
        <div class="product-card__info flx-between gap-2">
            ...
            <div class="flx-align gap-2">
                <h6 class="product-card__price mb-0">$160</h6>
                <span class="product-card__prevPrice text-decoration-line-through">$000</span>
            </div>
        </div>
        <div class="product-card__bottom flx-between gap-2">
            <div>
                <span class="product-card__sales font-14 mb-2">1000 Sales</span>
                <div class="d-flex align-items-center gap-1">
                    <ul class="star-rating">
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
    ...
    <div class="product-card__content">
        ...
        <div class="product-card__info flx-between gap-2">
            ...
            <div class="flx-align gap-2">
                <h6 class="product-card__price mb-0">$250</h6>
                <span class="product-card__prevPrice text-decoration-line-through">$300</span>
            </div>
        </div>
        <div class="product-card__bottom flx-between gap-2">
            <div>
                <span class="product-card__sales font-14 mb-2">320 Sales</span>
                <div class="d-flex align-items-center gap-1">
                    <ul class="star-rating">
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
    ...
    <div class="product-card__content">
        ...
        <div class="product-card__info flx-between gap-2">
            ...
            <div class="flx-align gap-2">
                <h6 class="product-card__price mb-0">$65</h6>
                <span class="product-card__prevPrice text-decoration-line-through">$85</span>
            </div>
        </div>
        <div class="product-card__bottom flx-between gap-2">
            <div>
                <span class="product-card__sales font-14 mb-2">1001 Sales</span>
                <div class="d-flex align-items-center gap-1">
                    <ul class="star-rating">
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
                        <li class="star-rating__item font-11"><i class="fas fa-star"></i></li>
